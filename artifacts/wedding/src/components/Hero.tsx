    ...
    <section id="home" className="relative min-h-screen pt-32 pb-20 flex flex-col items-center justify-center overflow-hidden">
      <div className="container mx-auto px-6 z-10 text-center max-w-4xl">
        <motion.div
          ...
          className="space-y-6"
        >
          <p className="uppercase tracking-[0.3em] text-sm text-muted-foreground">You're Invited To</p>
          ...
          <p className="text-lg md:text-xl text-muted-foreground tracking-wide font-light">
            August 2nd, 2026 <span className="mx-3 text-primary">•</span> Bekaa, Lebanon
          </p>
        ...
        >
          ...
          <div className="relative aspect-[3/4] md:mt-24 rounded-lg overflow-hidden shadow-xl hidden md:block">
            <img src="/images/hero3.jpg" alt="Joseph & Miriam" className="object-cover w-full h-full hover:scale-105 transition-transform duration-700" style={{ objectPosition: "35% 30%" }} />
          </div>
        </motion.div>
      </div>
