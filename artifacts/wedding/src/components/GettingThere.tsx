      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        >
          <div className="space-y-4">
            <span className="uppercase tracking-[0.2em] text-sm text-primary">Directions</span>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-muted-foreground font-light leading-relaxed">
                  1802 Damascus Hwy<br />
                  Chtaura, Beqaa Governorate<br />
                  Lebanon
                </p>
              </div>

              <div>
                <h4 className="text-sm uppercase tracking-widest text-primary mb-2">Parking</h4>
